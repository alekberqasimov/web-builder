...
export const makeNav=()=>node('nav',{logoText:'NOVA',logoImage:'',mode:'auto',items:[],desktopAlign:'center',mobileIcon:'☰',mobileIconPosition:'right',mobilePanel:'right',sticky:false,transparent:false,cta:{enabled:true,text:'Начать',link:linkNone()}});
