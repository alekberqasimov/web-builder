...
.library-card.is-premium::before{box-sizing:border-box!important;width:100%!important;max-width:100%!important;height:58px!important;flex:0 0 58px!important;background:radial-gradient(circle at 78% 20%,rgba(255,255,255,.28),transparent 24%),linear-gradient(135deg,#5f4ee9 0%,#8b5cf6 52%,#d468b7 100%)!important;border:1px solid rgba(255,255,255,.14)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.18)!important}
