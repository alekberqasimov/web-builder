...
.library-card.is-premium{position:relative;min-height:148px!important;padding:10px!important;align-content:end!important;overflow:hidden!important;border-color:rgba(126,107,237,.32)!important;background:linear-gradient(180deg,rgba(125,105,238,.08),rgba(255,255,255,.02))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 10px 28px rgba(22,18,55,.10)!important}
.library-card.is-premium::before{height:58px!important;flex-basis:58px!important;background:radial-gradient(circle at 78% 20%,rgba(255,255,255,.28),transparent 24%),linear-gradient(135deg,#5f4ee9 0%,#8b5cf6 52%,#d468b7 100%)!important;border:1px solid rgba(255,255,255,.14)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.18)!important}
.library-card.is-premium>span:first-child{top:31px!important;left:14px!important;width:32px!important;height:32px!important;color:#fff!important;background:rgba(12,15,28,.26)!important;border:1px solid rgba(255,255,255,.22)!important;backdrop-filter:blur(8px);font-weight:850!important}
...
.v6-premium-badge{position:absolute;top:13px;right:13px;z-index:3;display:inline-flex;align-items:center;justify-content:center;min-width:31px;height:18px;padding:0 6px;border:1px solid rgba(255,255,255,.25);border-radius:999px;background:rgba(11,15,29,.45);color:#fff;font-style:normal;font-size:8px;font-weight:850;letter-spacing:.08em;backdrop-filter:blur(8px)}
